...
const milestones = [
  { year: "2008", title: "Fundación", desc: "Nace Hard-Ware con el compromiso de dar servicio técnico sin burocracia." },
  { year: "2012", title: "Alianzas", desc: "Formalizamos relaciones con Zebra, Honeywell y Datalogic." },
  { year: "2017", title: "Expansión", desc: "Ampliamos servicios a gestión de garantías y monitoreo de flota." },
  { year: "2024", title: "Hoy", desc: "+500 equipos reparados al año. +120 clientes activos en la ZMM." },
];

const team = [
  { name: "Carlos Hdez.", role: "Director General", initial: "CH" },
  { name: "Ana López",    role: "Jefe de Servicio Técnico", initial: "AL" },
  { name: "Iván Torres",  role: "Especialista Zebra & Honeywell", initial: "IT" },
      ...
      <div className="container-lg">
        ...
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <h1
              className="text-5xl md:text-6xl font-extrabold text-ink mb-4"
              style={{ fontFamily: "'Syne', sans-serif" }}
            >
              Somos <span className="text-gradient">Hard-Ware</span>
            </h1>
            <p className="text-muted max-w-2xl mx-auto text-lg leading-relaxed">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Somos una empresa especializada en soluciones tecnológicas industriales con más de 15 años de experiencia en Monterrey, Nuevo León.
            </p>
          </div>
        </ScrollReveal>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            >
              <div>
                <span className="inline-block px-3 py-1 text-xs font-semibold uppercase tracking-widest rounded-full mb-4"
                  style={{ background: "rgba(250,183,2,0.2)", color: "#fab702" }}>
                  Misión
                </span>
                ...
                <p className="text-white/70 text-sm leading-relaxed max-w-lg">
                  Nuestra misión es garantizar la continuidad operativa de nuestros clientes a través de servicios técnicos especializados, oportunos y de alta calidad. Creemos que una empresa no debe detenerse por una falla de equipo.
                </p>
              </div>
              <div className="flex gap-6 mt-8">
                {[["15+", "Años"], ["500+", "Equipos/año"], ["120+", "Clientes"]].map(([val, lbl]) => (
                  <div key={lbl}>
                    <p className="text-2xl font-extrabold" style={{ color: "#fab702", fontFamily: "'Syne', sans-serif" }}>{val}</p>
                    <p className="text-xs text-white/50 uppercase tracking-wide">{lbl}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <ScrollReveal direction="right">
            <div className="bento-card h-full min-h-[240px] flex flex-col">
              ...
              <span className="text-xs font-semibold uppercase tracking-widest text-muted mb-2">Visión</span>
              <h3 className="text-xl font-bold text-ink mb-3" style={{ fontFamily: "'Syne', sans-serif" }}>
                Líderes en soporte técnico industrial
              </h3>
              <p className="text-muted text-sm leading-relaxed">
                Ser el aliado tecnológico de referencia para la industria en el norte de México, reconocidos por nuestra rapidez, especialización y compromiso con la operación de nuestros clientes.
              </p>
            </div>
          </ScrollReveal>
        </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {milestones.map((m, i) => (
                <div key={m.year} className="relative">
                  ...
                  <p className="text-lg font-extrabold text-accent" style={{ fontFamily: "'Syne', sans-serif" }}>
                    {m.year}
                  </p>
                  <p className="font-semibold text-ink text-sm mb-1">{m.title}</p>
        ...
        <ScrollReveal direction="up" delay={0.1}>
          <div className="mb-8">
            <h3 className="text-2xl font-extrabold text-ink mb-6 text-center" style={{ fontFamily: "'Syne', sans-serif" }}>
              Nuestro Equipo
            </h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {team.map((member, i) => (
                <div key={member.name} className="bento-card flex flex-col items-center text-center gap-3">
                  <div
                    className="w-16 h-16 rounded-full flex items-center justify-center font-bold text-lg"
                    style={{ background: "linear-gradient(135deg, #013383, #233060)", color: "#fab702" }}
                  >
                    {member.initial}
                  </div>
                  <div>
        ...
        <ScrollReveal direction="up" delay={0.2}>
          ...
          >
            ...
            <p className="text-white/70 text-sm mb-6 max-w-md mx-auto">
              Lorem ipsum dolor sit amet consectetur adipiscing elit. Contáctanos y descubre cómo podemos mantener tus equipos operando al máximo.
            </p>
            <a
              href="/contact"
