      ...
      <div className="container-lg">
        <ScrollReveal>
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold dark:text-white text-black mb-4">
              Socios <span className="text-gradient">Tecnológicos</span>
            </h2>
            <p className="text-muted max-w-lg mx-auto text-base leading-relaxed">
              Nos dimos a la tarea de mantener relaciones cercanas con las
              marcas líderes que resuelven los problemas de nuestros clientes.
            </p>
          </div>
        </ScrollReveal>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {partners.map((partner, i) => (
            <ScrollReveal key={partner.name} delay={i * 0.07} direction="up">
              <div className="bento-card flex flex-col items-center text-center gap-3 py-8 hover:border-primary dark:hover:border-accent transition-colors">
        ...
        <ScrollReveal delay={0.2} direction="up">
          <p className="text-center text-muted text-sm mt-10">
            ...
            para el desarrollo de proyectos tecnológicos de alto impacto.
          </p>
        </ScrollReveal>
      </div>
    </section>
