    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M10.5 1.5H8.25A2.25 2.25 0 0 0 6 3.75v16.5a2.25 2.25 0 0 0 2.25 2.25h7.5A2.25 2.25 0 0 0 18 20.25V3.75a2.25 2.25 0 0 0-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 8.25h3m-3 0a2.25 2.25 0 0 0-4.5 0c0 1.242 1.008 2.25 2.25 2.25h3m0 0a2.25 2.25 0 0 0 4.5 0m0 0V9.75"
        />
      </svg>
    ),
...
export default function ServicesSection() {
  return (
    <section
      id="services"
      className="section-padding bg-teal-50 dark:bg-slate-900/80"
    >
        ...
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <p className="text-muted max-w-xl mx-auto text-base leading-relaxed">
              Ofrecemos soluciones integrales para mantener la operación de tus
              equipos tecnológicos industriales sin interrupciones.
            </p>
          </div>
        </ScrollReveal>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((svc, i) => (
            <ScrollReveal key={svc.title} delay={i * 0.08} direction="up">
              <article
                className={`bento-card group flex flex-col gap-4 bg-linear-to-br ${svc.color} border ${svc.border} dark:border-white/10 dark:bg-none dark:bg-panel h-full`}
              >
          ...
          >
            <div className="text-left">
              ...
              <p className="text-white/70 text-sm">
                Nuestro equipo técnico está listo para atenderte. Sin póliza,
                sin complicaciones.
              </p>
            </div>
            <a
